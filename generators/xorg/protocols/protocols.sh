...
RESOURCE_LOCATION="${EXEC_DIR%/generators/xorg/protocols}"
...
INPUT="protocols_packages.conf"
PKG_VERSIONS="protocols_package_versions"
SRC_PKG_EXTENSION="xorg-protocols.mk"
META_PACKAGE="x-proto-headers-dev"
...
function generate_build_system
{
    ...
    do
        ...
        # Configure files
        echo "This file was generated by generators/xorg/protocols." > "$PKG_DIR"/README
