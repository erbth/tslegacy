...
RESOURCE_LOCATION="${EXEC_DIR%/generators/xorg/xorg_fonts}"
...
GENERATOR_NAME="xorg_fonts"
INPUT="${GENERATOR_NAME}_packages.conf"
PKG_VERSIONS="${GENERATOR_NAME}_package_versions"
SRC_PKG_EXTENSION="${GENERATOR_NAME}.mk"
META_PACKAGE="xorg-fonts"

GENERATOR_README_MESSAGE="This file was generated by generators/xorg/${GENERATOR_NAME}."
...
function generate_build_system
{
    ...
    do
        ...
        # Configure files
        echo "$GENERATOR_README_MESSAGE" > "$PKG_DIR"/README
    ...
    do
        ...
        META_CDEPS="$META_CDEPS${PKG}_installed"
        ...
        META_RDEPS="$META_RDEPS"'$(call bigger_equal_dep,'"$PKG"')'
    done
    ...
    sed -e "s/skel/$META_PACKAGE/g" \
        "${GENERATOR_DIR}/meta/skel_README.tslegacy.in.in" \
