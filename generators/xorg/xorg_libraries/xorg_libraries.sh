# No shebang here as the caller has to locate the local bash executable.
# Btw. this is a bash script ...
...
RESOURCE_LOCATION="${EXEC_DIR%/generators/xorg/xorg_libraries}"
...
INPUT="xorg_libraries_packages.conf"
PKG_VERSIONS="xorg_libraries_package_versions"
SRC_PKG_EXTENSION="xorg-libraries.mk"
META_PACKAGE="xorg-libraries-dev"
...
function generate_build_system
{
    ...
    do
        ...
        # Configure files
        echo "This file was generated by generators/xorg/xorg_libraries." > "$PKG_DIR"/README
        ...
        # Amend the Makefile if the source package requires additional
        # configuration
        # (Taken from the book
